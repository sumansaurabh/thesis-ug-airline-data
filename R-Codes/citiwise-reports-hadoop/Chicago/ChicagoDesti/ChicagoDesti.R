  ...
  extractTop20 = function(line) {
    ...
    if (length(fields) == 21) {
     ...
     # Skip records where departure dalay is "NA":
        ...
        if(identical(desti,"CGX")||identical(desti,"MDW")||identical(desti,"ORD"))
...
write(counts, file="Chicagodesti.dat")
