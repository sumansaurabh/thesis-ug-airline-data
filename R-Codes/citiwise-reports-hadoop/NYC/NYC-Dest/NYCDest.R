  ...
  extractTop20 = function(line) {
    ...
    if (length(fields) == 21) {
     ...
     # Skip records where departure dalay is "NA":
        ...
        if(identical(destination,"6N5")||identical(destination,"6N7")||identical(destination,"JFK")||identical(destination,"JRA")||identical(destination,"JRB")||identical(destination,"LGA"))
...
z <- rhwatch(
  ...
  jobname='NYC Destination Details',
...
write(counts, file="NYCDestination.dat")
