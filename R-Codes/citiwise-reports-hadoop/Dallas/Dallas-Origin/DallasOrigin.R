  ...
  extractTop20 = function(line) {
    ...
    if (length(fields) == 21) {
     ...
     # Skip records where departure dalay is "NA":
        ...
        if(identical(origin,"DAL")||identical(origin,"DFW")||identical(origin,"RBD")||identical(origin,"4GT"))
...
write(counts, file="Dallasorigin.dat")
