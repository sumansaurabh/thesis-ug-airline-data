  ...
  extractTop20 = function(line) {
    ...
    if (length(fields) == 21) {
     ...
     # Skip records where departure dalay is "NA":
        ...
        if(identical(destination,"DAL")||identical(destination,"DFW")||identical(destination,"RBD")||identical(destination,"4GT"))
...
z <- rhwatch(
  ...
  jobname='Dallas Destination Details',
...
write(counts, file="Dallasdesti.dat")
