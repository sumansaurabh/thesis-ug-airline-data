...
airport<-read.csv("/home/perfectus/Desktop/btp/airline-dataset/rhipe-airlie/resultset/citiwise-reports/Chicago/Chicago-AirportPopularity/origin/ChicagoAirportOrigin.csv",sep="\t",header = F)
