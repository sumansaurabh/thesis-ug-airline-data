...
library("ggplot2")
library(scales)
airport<-read.csv("/home/perfectus/Desktop/btp/airline-dataset/rhipe-airlie/resultset/citiwise-reports/NYC/NYC-DelayRate/Origin/Airport/NYCDelay-airport.csv",sep="\t",header=F)
