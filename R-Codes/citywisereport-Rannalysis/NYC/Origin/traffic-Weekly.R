...
airport<-read.csv("/home/perfectus/Desktop/btp/airline-dataset/rhipe-airlie/resultset/citiwise-reports/NYC/NYCTotalFlight/Origin/weekly/NYCTot-week.csv",sep="\t",header = F)
